...
public class BambangRageScript : MonoBehaviour {
	...
	void Update () {
		...
		if (Time.timeScale != 0) {
			...
			if (sAttackTimer <= 0) {
				...
				if (sAttack4) {
					tourScript.p1Anim.SetInteger ("FightMove", 18);
					tourScript.hihiVoice.Play ();
				}
			...
			if (tourScript.p2Anim.GetInteger ("FightMove") == 10 && tourScript.player2.transform.position.x > 2f && tourScript.player2.transform.position.x < 3f) {
				if (block) {
					...
					tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.GetComponent<RectTransform> ().rect.width - (p2SAtt1Damage / 2), tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
				
					p2SAtt1Damage = p2SAtt1Damage / 2;
					...
					tourScript.hitSound.Play ();
					Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.rect.width - p2SAtt1Damage, tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
			...
			if (tourScript.p2Anim.GetInteger ("FightMove") == 11 && tourScript.player2.transform.position.x > 2f && tourScript.player2.transform.position.x < 3f) {
				if (block) {
					...
					Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.rect.width - (p2SAtt2Damage / 2), tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
				
					p2SAtt2Damage = p2SAtt2Damage / 2;
					...
					Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
					Instantiate (Resources.Load ("Prefabs/PunchClash3"), new Vector3 (transform.position.x, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.rect.width - p2SAtt2Damage, tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
					tourScript.hitText.text = "-" + p2SAtt2Damage.ToString ();
					tourScript.p1HitTextFollow = true;
				}
				StartCoroutine ("HitTextFadeOut");
			...
			if (tourScript.P2Id == 3) {
				...
				if (tourScript.p2SAttack3Timer <= 0) {
					...
					if (!block && !dodge) {
						...
						Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
						tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.GetComponent<RectTransform> ().rect.width - p2SAtt3Damage, tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
				...
				if (tourScript.p2Anim.GetInteger ("FightMove") == 12 && tourScript.p2SAttack3Timer <= 39f && tourScript.p2SAttack3Timer > 38f) {
					if (block) {
						...
						Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
						Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
						tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.rect.width - (p2SAtt3Damage / 2), tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
						p2SAtt3Damage = p2SAtt3Damage / 2;
						tourScript.hitText.text = "-" + p2SAtt3Damage.ToString ();
						tourScript.p1HitTextFollow = true;
						p2SAtt3Damage = p2SAtt3Damage * 2;
						StartCoroutine ("HitTextFadeOut");
				...
				if (tourScript.p2Anim.GetInteger ("FightMove") == 12 && tourScript.player2.transform.position.x > 2f && tourScript.player2.transform.position.x < 3f) {
					if (block) {
						...
						Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
						Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
						tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.GetComponent<RectTransform> ().rect.width - (p2SAtt3Damage / 2), tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
						...
						tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.rect.width - p2SAtt3Damage, tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
			...
			if (tourScript.p2Anim.GetInteger ("FightMove") == 18 && tourScript.player2.transform.position.x > 2f && tourScript.player2.transform.position.x < 3f) {
				if (block) {
					...
					Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
					Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x - 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p1HBar.sizeDelta = new Vector2 (tourScript.p1HBar.GetComponent<RectTransform> ().rect.width - (p2SAtt4Damage / 2), tourScript.p1HBar.GetComponent<RectTransform> ().rect.height);
				
					p2SAtt4Damage = p2SAtt4Damage / 2;
			...
			bonangScript.SAttack1 = false;
			bonangScript.SAttack2 = false;
			bonangScript.SAttack3 = false;*/
