...
public class RonChatScript : MonoBehaviour, IPointerDownHandler {
	...
	void Update () {
        ...
        {
            manager.cloudButton[4].SetActive(false);
        }
        else
        {
    ...
    void ChatOn ()
    {
        ...
        manager.panelText.text = "RON:\n\n" +
            "I sense a DARK POWER lurking inside you...";
    }
