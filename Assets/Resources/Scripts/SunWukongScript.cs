...
public class SunWukongScript : MonoBehaviour {
	...
	void Update () {
		...
		if (Time.timeScale != 0) {
			...
			if (kintounPass) {
				...
				kintoun = Instantiate (Resources.Load ("Prefabs/Kintoun0"), new Vector3 (4, 2, 0), Quaternion.identity) as GameObject;
				kintounPass = false;
			}
			...
			if (transform.position.y < 0.1f && wukongJump) {
				transform.position = new Vector3 (4, 0, 0);
				tourScript.p2Anim.SetInteger ("FightMove", 2);
			}
			if (transform.position.y == 0 && wukongJump) {
				wukongJump = false;
			}
			...
			if (tourScript.p2Att4Active.GetComponentInChildren<RectTransform> ().anchoredPosition.y == 32f && tourScript.fighting) {
			...
			if (p2SAttAction == 1 || p2SAttAction == 2 || p2SAttAction == 3 || p2SAttAction == 4 || p2SAttAction == 5 || p2SAttAction == 6) {
			...
			if (tourScript.p2SAttack4) {
				...
				tourScript.p2AttBar2.sizeDelta = new Vector2 (tourScript.p2AttBar2.GetComponent<RectTransform> ().rect.width - 200f, tourScript.p2AttBar2.GetComponent<RectTransform> ().rect.height);
				tourScript.Initial ();
			...
			if (tourScript.p2Anim.GetInteger ("FightMove") == 17 && transform.position.x > 3.9f && !wukongJump) {
				tourScript.p2Anim.SetInteger ("FightMove", 2);
...
//			}
				if (tourScript.p2SAttack3) {
					...
					tourScript.hawaVoice.Play ();
				}
				sAttackTimer = sAttackTimerMax;
			}
		
			if (tourScript.p2Anim.GetInteger ("FightMove") == 18) {
				...
				Instantiate (Resources.Load ("Prefabs/RonShadow"), new Vector3 (transform.position.x, transform.position.y, transform.position.z), Quaternion.identity);
			...
			if (tourScript.p2SAttack3Timer <= 0) {
				Instantiate (Resources.Load ("Prefabs/ElectroBall2"), new Vector3 (transform.position.x - 3f, -0.2f, transform.position.z), Quaternion.identity);
			...
			if (tourScript.p1Anim.GetInteger ("FightMove") == 10 && tourScript.player1.transform.position.x > -3f && tourScript.player1.transform.position.x < -2f) {
				...
				if (block) {
					...
					tourScript.p2HBar.sizeDelta = new Vector2 (tourScript.p2HBar.GetComponent<RectTransform> ().rect.width - (p1SAtt1Damage / 8), tourScript.p2HBar.GetComponent<RectTransform> ().rect.height);
				
					p1SAtt1Damage = p1SAtt1Damage / 8;
			...
			if (tourScript.p1Anim.GetInteger ("FightMove") == 11 && tourScript.player1.transform.position.x > -3f && tourScript.player1.transform.position.x < -2f) {
				...
				if (block) {
					...
					Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p2HBar.sizeDelta = new Vector2 (tourScript.p2HBar.GetComponent<RectTransform> ().rect.width - (p1SAtt2Damage / 8), tourScript.p2HBar.GetComponent<RectTransform> ().rect.height);
				
					p1SAtt2Damage = p1SAtt2Damage / 8;
			...
			if (tourScript.p1Anim.GetInteger ("FightMove") == 18 && tourScript.player1.transform.position.x > -3f && tourScript.player1.transform.position.x < -2f) {
				...
				if (block) {
					...
					Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.identity);
					Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p2HBar.sizeDelta = new Vector2 (tourScript.p2HBar.GetComponent<RectTransform> ().rect.width - (p1SAtt4Damage / 8), tourScript.p2HBar.GetComponent<RectTransform> ().rect.height);
				
					p1SAtt4Damage = p1SAtt4Damage / 8;
			...
			if (tourScript.p1SAttack3Timer <= 0) {
				...
				if (block) {
					...
					Instantiate (Resources.Load ("Prefabs/Hit"), new Vector3 (transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.identity);
					Instantiate (Resources.Load ("Prefabs/BlockClash"), new Vector3 (transform.position.x + 1, transform.position.y, transform.position.z), Quaternion.identity);
					tourScript.p2HBar.sizeDelta = new Vector2 (tourScript.p2HBar.GetComponent<RectTransform> ().rect.width - (p1SAtt3Damage / 8), tourScript.p2HBar.GetComponent<RectTransform> ().rect.height);
					p1SAtt3Damage = p1SAtt3Damage / 8;
			...
			// --- P2 Loses ---
			if (tourScript.p2HBar.GetComponent<RectTransform> ().rect.width <= 0) {
				if (tourScript.tournamentNumb == 4) {
